	...
	public function format($source) {
		...
		while (list($index, $token) = each($this->tkns)) {
			...
			case T_NEW:
				...
				list($foundId, $foundText, $touchedLn) = $this->printAndStopAt([ST_PARENTHESES_OPEN, ST_PARENTHESES_CLOSE, T_COMMENT, T_DOC_COMMENT, ST_SEMI_COLON, ST_COMMA, ST_BRACKET_CLOSE]);
