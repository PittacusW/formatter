...
final class UpgradeToPreg extends AdditionalPass {
	private static $conversionTable = ['ereg' => ['to' => 'preg_match', 'modifier' => ''], 'ereg_replace' => ['to' => 'preg_replace', 'modifier' => ''], 'eregi' => ['to' => 'preg_match', 'modifier' => 'i'], 'eregi_replace' => ['to' => 'preg_replace', 'modifier' => 'i'], 'split' => ['to' => 'preg_split', 'modifier' => ''], 'spliti' => ['to' => 'preg_split', 'modifier' => 'i']];
	private static $delimiters = ['/', '#', '!'];
	public function candidate($source, $foundTokens) {
		return (false !== stripos($source, 'ereg') || false !== stripos($source, 'split'));
	}
