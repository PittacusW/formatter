...
* $oBatch= new Batch($oBeaut); // Decorator
...
class Batch extends Decorator {
    ...
    */
    ...
    /**
    * @var array    Batch_Input
    */
    private $aBatchInputs;
    public $mInputFiles;
    /**
    * Output mode.  Could be {@link Batch::FILES} or
    *               {@link Batch::DIRECTORY}
    */
    private $sOutputMode;
    const FILES = 'Files';
    ...
    private function setOutputFilePost() 
    {
        if (php_sapi_name() == 'cli' and $this->sPreOutputFile == STDOUT) {
            ...
            if (substr($sPath, -1) != '/' and !is_dir($sPath)) {
                ...
                $this->sOutputMode = Batch::DIRECTORY;
            }
        }
        return true;
    }
    ...
    */
    ...
    private function getBatchEngine() 
    {
        ...
        $sClassEngine = 'Batch_Output_'.$sClass;
    ...
    */
    ...
    /**
    * Allows subclass of {@link Batch_Engine} call methods of {@link $oBeaut}
    * @param    Batch_Engine
    * @param    string method to call
    * @param    array  array of args
    * @return   mixed
    */
    public function callBeautifier(Batch_Output $oEngine, $sMethod, $aArgs = array()) 
    {
